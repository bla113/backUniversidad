           ...
           <div class="layout-page">
               ...
               <div class="content-wrapper mb-4">
                   ...
                   <div class="container-xxl flex-grow-1 container-p-y">
                       ...
                       <?php
                        $datos = ControladorEstudiante::ctrCrearEstudiante();
                        //print_r($datos);

                        $Carnet=ControladorEstudiante::ctrMostraProximoCarnet();
                       // print_r($Carnet);
                                           ...
                                           <?php
                                            ...
                                            ?>
                                               ...
                                               <div class="mb-3">
                                                   ...
                                                   <label class="form-label" for="basic-icon-default-phone">Número de Carnet </label>

                                                   <div class="input-group input-group-merge">

                                                       <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-card"></i></span>

                                                       <input type="text" name="nuvoCarnet" value="<?php 
                                                       foreach ($Carnet as $carnet) {
                                                       echo $carnet['carnet']+1;
                                                       }
                                               ...
                                               <button type="submit" name="btnGuardarEstudiante" class="btn btn-primary">Guardar</button>
