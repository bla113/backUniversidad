...
=============================================*/
  ...
  BUSCAR ESTUDIANTE
=============================================*/
    static public function ctrBuscarEstudinate()
    {
        ...
        if (isset($_POST["BTNBUSCARCEDULA"])) {
            ...
            if (preg_match('/^[0-9]+$/', $_POST["buscarIdentificacion"])) {
                ...
                $estudiantes = ModeloEstudiante::mdlMostrarEstudiantes($tablaE, $itemE, $valorE);
                ...
                foreach ($estudiantes as $estudiante) {
                    ...
                    swal({
                        ...
                        type: "error",
                        title: "¡ Este  Estudiante ya tiene una cuenta activa",
...
=============================================*/
    static public function ctrCrearEstudiante()
    {
        ...
        if (isset($_POST['btnGuardarEstudiante'])) {
            ...
            /*=============================================
                       FIN VALIDAR LOS DATOS DEL FORMULARIO STUDIANTE
                =============================================*/
         ...
         - Se permiten archivos .gif, .jpg, .png. y de 200 kb como máximo.</b></div>';
                    ...
                    if (move_uploaded_file($temp, 'vistas/img/estudiantes/' . $_POST['nuevaCedula'] . ".png")) {


                        //Cambiamos los permisos del archivo a 777 para poder modificarlo posteriormente
                        chmod('vistas/img/estudiantes/' . $_POST['nuevaCedula'] . ".png", 0777);
                        $ruta = 'vistas/img/estudiantes/' .  $_POST['nuevaCedula'] . ".png";
                        //Mostramos el mensaje de que se ha subido co éxito
                        echo '<div><b>Se ha subido correctamente la imagen.</b></div>';
                        //Mostramos la imagen subida
                        echo '<p><img src="vistas/img/estudiantes/' . $_POST['nuevaCedula'] . '.png"></p>';
                    } else {
            ...
            $nevoCarnet = $_POST['nuvoCarnet'] . '-' . date("y");
            ...
            //return $datos;
            $tablaC = 'carnet_estudiante';
            $datosC = $_POST['nuvoCarnet'];
            $creaCarnet = ModeloEstudiante::mdlCrearCarnet($tablaC, $datosC);
        ...
        =============================================*/
    } // FIN CONTROLADOR DE CREAR ESTUDIANTE
    static public function ctrAsignarMatriasdeCarrera()
    {
        if (isset($_POST['btnAsiganarCarrera'])) {
            $tablaCarrerra = 'vista_materias_por_carreras';
            $valor =$_POST['IdCarrera'] ; 	
            $item='IDCARREAR'; 
            $traerMateriasdeCarrera= ModeloMateria::mdlTraerMateriaPorCarrera($tablaCarrerra,$item,$valor);
           //return $traerMateriasdeCarrera;
           $Tablas='estudiante';
           $Datos=[
            'id'=>$_POST['IdEstudiante'],
            'carrera'=>$_POST['IdCarrera']
           ];
            $AsiganaCarrera=ModeloEstudiante::mdlAsiganarCarreraEstudiante($Tablas,$Datos);

            //return  $AsiganaCarrera;

            foreach ($traerMateriasdeCarrera as $key => $value) {
                $datos = [
            ...
            $tabla='estudiante_materia';
             $respuesta=ModeloEstudiante::mdlASignarMateriasaEstudiante($tabla,$datos);
             if ($respuesta == "ok") {
                ...
                echo '<script>
                        ...
                        swal({
                            ...
                            type: "success",
                            title: "¡Carrera Asiganada correctamente!",
                            showConfirmButton: true,
                            confirmButtonText: "Cerrar"
